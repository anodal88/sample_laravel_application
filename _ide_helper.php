...
namespace {
    ...
    class Paypal extends \Netshell\Paypal\Facades\Paypal{
         ...
         * 
         *
         * @return \Netshell\Paypal\Paypal\Api\FlowConfig 
         * @static 
         */
        public static function FlowConfig(){
            return \Netshell\Paypal\Paypal::FlowConfig();
        }
        
        /**
         * 
         *
         * @return \Netshell\Paypal\Paypal\Api\Presentation 
         * @static 
         */
        public static function Presentation(){
            return \Netshell\Paypal\Paypal::Presentation();
        }
         ...
         * 
         *
         * @return \Netshell\Paypal\Paypal\Api\InputFields 
         * @static 
         */
        public static function inputFields(){
            return \Netshell\Paypal\Paypal::inputFields();
        }
         ...
         * 
         *
         * @return \Netshell\Paypal\Paypal\Api\WebProfile 
         * @static 
         */
        public static function webProfile(){
            return \Netshell\Paypal\Paypal::webProfile();
        }
